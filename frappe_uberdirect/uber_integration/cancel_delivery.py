"""Background job canceling a quote for an order."""
...
def cancel_delivery(delivery_id: str, payload: dict = None) -> dict:
    """Cancel a delivery."""
    ...
    # prepare url
    url = prepare_url(f"/customers/{customer_id}/deliveries/{delivery_id}/cancel")
    ...
    if response.status_code != 200:
        msg = f"Failed to cancel delivery. Status code: {response.status_code}. Response: {response.text}"
        frappe.throw(msg=msg, exc=frappe.ValidationError)
